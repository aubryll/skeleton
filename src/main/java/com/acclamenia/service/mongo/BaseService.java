...
package com.acclamenia.service.mongo;
...
import com.acclamenia.repository.BaseMongoRepository;
...
@Transactional
public abstract class BaseService<T extends BaseModel, V extends BaseDto, E extends BaseMongoRepository<T>> implements IBaseService<T, V> {
